...
//   if (token == null) {
//     ScaffoldMessenger.of(context).showSnackBar(
//       SnackBar(content: Text("حدث خطأ: لا يوجد رمز مميز للمستخدم")),
//     );
//     return;
//   }
//
...
//     location: location,
//     cv: cvController?.path, // أو upload CV logic لو عندك
//   );
//
//   // ✅ 2. نفذي الـ API call
...
//       // ❌ حالة الخطأ
//       ScaffoldMessenger.of(context).showSnackBar(
//         SnackBar(content: Text("فشل في التحديث: ${failure.errorMessage}")),
//       );
//     },
//         (response) async {
//       // ✅ حالة النجاح
//
//       // 3. خزني البيانات الجديدة في SharedPreferences
//       await SharedPrefsHelper.saveUserData(
//         username: username,
//         email: email,
//         employmentStatus: employmentStatus,
...
//       );
//
//       Navigator.pop(context); // أو أي إجراء بعد التحديث
//     },
//   );
// }