    ...
    return  Scaffold(
              ...
              Row(
                ...
                children: [
                  Padding(
                    ...
                    child: Text("الفرق الدراسية",style: TextStyle(fontFamily: "Noto Kufi Arabic",
                    fontSize: 15.sp,
      ...
      Navigator.push( 
        ...
        MaterialPageRoute(builder: (context) => Team1()),
              ...
              child: SvgPicture.asset("assets/images/groub1.svg",
              width: 348.w,
              height: 96.5.h,
              ),
            ),
      ...
      Navigator.push( 
        ...
        MaterialPageRoute(builder: (context) => Team2()),
              ...
              child: SvgPicture.asset("assets/images/groub2.svg",
              width: 348.w,
              height: 96.5.h,
              ),
            ),
      ...
      Navigator.push( 
        ...
        MaterialPageRoute(builder: (context) => Team3()),
              ...
              child: SvgPicture.asset("assets/images/groub3.svg",
              width: 348.w,
              height: 96.5.h,
              ),
            ),
      ...
      Navigator.push( 
        ...
        MaterialPageRoute(builder: (context) => Team4()),
              ...
              child: SvgPicture.asset("assets/images/groub4.svg",
              width: 348.w,
              height: 96.5.h,
              ),
            ),
