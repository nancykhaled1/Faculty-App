...
class Team3 extends StatefulWidget {
  const Team3({super.key});

  @override
  State<Team3> createState() => _Team1State();
}

class _Team1State extends State<Team3> {
  @override
              ...
              Row(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(" الفرقة الثالث",style: TextStyle(fontFamily: "Noto Kufi Arabic",
                    fontSize: 15.sp,
...
Text("أرقام جلوس المستوى الثالث",
