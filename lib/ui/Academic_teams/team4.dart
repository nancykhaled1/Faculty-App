...
class Team4 extends StatefulWidget {
  ...
  @override
  State<Team4> createState() => _Team1State();
}

class _Team1State extends State<Team4> {
  @override
              ...
              Row(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(" الفرقة الرابعة",style: TextStyle(fontFamily: "Noto Kufi Arabic",
                    fontSize: 15.sp,
...
Text("أرقام جلوس المستوى الرابع",
